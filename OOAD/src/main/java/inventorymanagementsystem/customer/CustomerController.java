...
import inventorymanagementsystem.util.CsvConverter;
import inventorymanagementsystem.util.CsvConversionException;
...
public class CustomerController {
    ...
    public String createAllProducts(
        ...
        try {
            ...
            customerService.createAllCustomers(customers.stream().map(CustomerForm::toEntity).toList());
